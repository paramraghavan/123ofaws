...
if __name__ == "__main__":
    """
    Using boto 3  api from my browfield server or my aws cli enabled laptop  run ssm command on ec2 edge nodes. 
    I have configuration which has n edge/ec2 nodes, where lets say n is 5. From my pc i want to run command
    on least loaded edge node. All edgenode have name that contain text  "param-dev-node". 
    Let's say it runs a  helloworld python program on these nodes with current date time
    """
