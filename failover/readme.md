...
- 🔍 **Auto-detection** of EC2 instances and EMR clusters
- 📊 **Real-time status logging** with detailed tracking
- 🔄 **Automated failover** with EC2 restart and EMR recreation
...
- IAM permissions for EC2 and EMR operations:
...
- **Python/Flask**: Refer to official docs
- **This tool**: Review logs in `logs/failover.log`