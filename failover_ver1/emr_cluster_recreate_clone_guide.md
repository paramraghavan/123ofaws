...
## Bootstrap Actions - Important Information

**Bootstrap actions ARE now automatically copied** when using the Failover Manager's clone and recreate functions.
Bootstrap actions include:

- ✅ Script paths (S3 locations)
- ✅ Script arguments
- ✅ Script names
- ✅ Execution order

All bootstrap actions will run in the same order on the new cluster during startup.
